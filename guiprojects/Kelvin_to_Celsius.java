 ...
 * @author HP
 */
public class Kelvin_to_Celsius extends javax.swing.JFrame {

    /**
     * Creates new form Kelvin_to_Celsius
     */
    ...
    private void kelvin_to_celsius(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kelvin_to_celsius
        // TODO add your handling code here:
       
        double val  = Double.parseDouble(jTextField1.getText());
       double conv = (double) (val - 273.15);
        jTextField2.setText("" + conv);
        
        double val2 = Double.parseDouble(jTextField2.getText());
        double conv_back = (double) (val2 + 273.15);
        jTextField1.setText(""+conv_back);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kelvin_to_Celsius.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kelvin_to_Celsius().setVisible(true);
            }
        });
    }
