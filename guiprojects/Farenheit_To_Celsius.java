 ...
 * @author HP
 */
public class Farenheit_To_Celsius extends javax.swing.JFrame {

    /**
     * Creates new form Farenheit_To_Celsius
     */
    public Farenheit_To_Celsius() {
        initComponents();
    }
    ...
    private void farenheit_to_celsius(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_farenheit_to_celsius
        // TODO add your handling code here:
        
        double val  = Double.parseDouble(jTextField1.getText());
        double conv = (double) ((double) (((val - 32) * 5.00 )/ 9.00));
        jTextField2.setText("" + conv+" c");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Farenheit_To_Celsius.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Farenheit_To_Celsius().setVisible(true);
            }
        });
    }
